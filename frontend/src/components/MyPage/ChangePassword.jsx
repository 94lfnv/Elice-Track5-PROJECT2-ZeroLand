    ...
    <div>
        ...
        <div className="container my-5 pe-5" >
            <div className="row">
                ...
                <p className={isPwdValid ? 'success text-secondary' : 'error text-secondary'}>{pwdMsg}</p>
            </div>
        </div>
        <div className="container my-5 pe-5" >
            <div className="row">
                ...
                <p className={isConfirmPwd ? 'success text-secondary' : 'error text-secondary'}>{confirmPwdMsg}</p>
            </div>
        </div>
        <div>
            <div>
                <button onClick={()=>{changeMenu(<Info changeMenu={changeMenu} />)}}>취소</button>
                <button type="submit" disabled={!isAllValid} onClick={()=>{changeMenu(<Info changeMenu={changeMenu} />)}}>변경하기</button>
            </div>
